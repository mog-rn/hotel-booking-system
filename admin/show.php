...
@page { margin: 0; }
	...
	?>
		<header>
			...
			<address >
				<p>COCOON LUXURY HOTEL,</p>
				<p>Nairobi,<br>Westlands,<br>ABC.</p>
				<p>+254-711-282-331</p>
			</address>
			<span><h2 style="font-weight: 600; font-size: 45px; font-style: italic; color: #1e3c4c"><b>COCOON LUXURY</b></h2></span>
		</header>
		<article>
			<h1></h1>
			<address >
			...
			<table >
					...
					<tr> 
						<td>Customer County : -  <?php echo $country; ?> </td>
						<td>Customer Nationality : -  <?php echo $National; ?> </td>
					</tr>
				</table>
				<br>
				<br>
		...
		<aside>
			...
			<div >
				<p align="center">Email :- info@cocoon.com || Web :- www.cocoonluxury.com || Phone :- +245-711-282-331 </p>
			</div>
		</aside>
	</body>
</html>
